...
/** End of old RTC config block **/
    ...
    TEXT_SETTING(0, audiobook_extensions, "audiobook extensions",
                 "m4b", NULL, NULL),
    INT_SETTING(F_TIME_SETTING, audiobook_skip_length, LANG_SKIP_LENGTH, 20,
                "audiobook skip length", UNIT_SEC, 0, 600, 5,
                NULL, NULL, NULL),
    INT_SETTING(F_TIME_SETTING, audiobook_pause_rewind, LANG_PAUSE_REWIND, 2,
                "audiobook rewind duration on pause", UNIT_SEC, 0, 60, 1,
                NULL, NULL, NULL),
    CHOICE_SETTING(0, audiobook_autocreatebookmark,
                   LANG_BOOKMARK_SETTINGS_AUTOCREATE, BOOKMARK_YES,
    ...
    CHOICE_SETTING(0, audiobook_autoloadbookmark,
                   LANG_BOOKMARK_SETTINGS_AUTOLOAD, BOOKMARK_YES,
    ...
    CHOICE_SETTING(0, audiobook_usemrb,
                   ...
                   ID2P(LANG_BOOKMARK_SETTINGS_ONE_PER_TRACK)),
#ifdef HAVE_TAGCACHE
    BOOL_SETTING(0, audiobook_autoresume_enable, LANG_AUTORESUME, true,
                 "audiobook autoresume enable", off_on,
                 LANG_SET_BOOL_YES, LANG_SET_BOOL_NO, NULL),
#endif
    /* --- end audiobook -------------------------------------------------- */
